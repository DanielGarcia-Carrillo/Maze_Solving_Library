...
import Solver.heuristics.ManhattanDistance;
import model.Maze;
...
public class AStarMazeSolverTest {
	...
	private final Heuristic heuristic = new ManhattanDistance();
	...
	public void testSimplestMaze() {
		...
		List<Position> path = solver.solve(new Maze(simplestMaze, start, end), heuristic);
	...
	public void testRectangularMaze() {
		...
		List<Position> path = solver.solve(rectangleMaze, heuristic);
	...
	public void testUnsolvableMaze() {
		...
		List<Position> noPath = solver.solve(unsolvableMaze, heuristic);
